        ...
        <div className='w-1/2'>
          ...
          <div className='flex'>
            <div className='pr-4 '>
              ...
              <a className='text-slate-600' href="mailto:ajmalaj8085@gmail.com">ajmalaj8085@gmail.com</a><br />
              <a className='text-slate-600' href="tel:+916282214013">+91 7306129332</a>
            </div>
